class Blog < ApplicationRecord
	belongs_to :tourist, optional: true #外部キーにnullが入ることを許容
	belongs_to :guide, optional: true #外部キーにnullが入ることを許容
  ...
  def favorited_by_guide?(guide) #guide_signed_in?時の定義 /blogs/_favorite.html.erb
	...
	enum region: {北海道: 1, 青森県: 2, 岩手県: 3, 宮城県: 4, 秋田県: 5, 山形県: 6, 福島県: 7, 
